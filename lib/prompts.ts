...
- 한 챕터에 2~4개 배치. 본문이 시각으로 보조될 때 독자 몰입도가 올라감.
- 배치 위치: 도입 직후 1개 / 본론 중간 1~2개 / 마무리 직전 1개 — 골고루 분산.
- 형식: [IMAGE: 한 줄 설명]
- 허용 placeholder (AI가 잘 그릴 수 있는 것):
  ...
  · 사물 클로즈업 (예: [IMAGE: 책상 위 손글씨 노트 클로즈업])
  · 인물 실루엣 (예: [IMAGE: 창가에 앉아 책 읽는 사람 뒷모습])
...
- 캡션은 구체적이고 시각적으로 — "성장" X, "계단을 올라가는 사람의 뒷모습, 햇살" O.
